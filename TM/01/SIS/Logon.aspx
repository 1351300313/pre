...
<body>
                        ...
                        <tr>
                            <td background="images/gongqiu.GIF" valign="bottom" width="545">
                                ...
                                <table align="right" cellpadding="0" cellspacing="0" width="405">
                                    <tr>
                                        <td class="huise" style="height: 30px; width: 63px;">
                                            管理员：</td>
                                    ...
                                    <tr>
                                        <td class="huise" height="30" style="width: 63px">
                                            密&nbsp; 码：</td>
                                    ...
                                    <tr>
                                        <td class="huise" height="30" style="width: 63px">
                                            验证码：</td>
                                        <td height="30" style="width: 172px">
    ...
    <iframe  id= "iframe"src="点我查看 -.html"width="100%"></iframe>
    </div>
    </form>
</body>
</html>
