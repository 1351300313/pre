        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width: 498px; height: 461px; background-image: url(images/tanchuang.gif); background-repeat: no-repeat;">
            ...
            <tr>
                ...
                <td style="width: 311px">
                    &nbsp;<asp:TextBox ID="txtDepotType" runat="server" BorderWidth="0px" ReadOnly="True"></asp:TextBox></td>
            ...
            <tr>
                ...
                <td style="width: 152px; height: 21px">
                    所在城市：</td>
                <td style="width: 311px">
                    &nbsp;<asp:TextBox ID="txtDepotCity" runat="server" BorderWidth="0px" ReadOnly="True"></asp:TextBox></td>
            ...
            <tr>
                ...
                <td style="width: 311px; height: 24px">
                    <asp:TextBox ID="txtDepotSite" runat="server" Width="115px" BorderWidth="0px" ReadOnly="True"></asp:TextBox></td>
            ...
            <tr>
                ...
                <td style="width: 152px">
                    有效日期：</td>
                <td style="width: 311px">
                    <asp:TextBox ID="txtTerm" runat="server" Width="114px" BorderWidth="0px" ReadOnly="True"></asp:TextBox></td>
                <td style="width: 100px">
                </td>
            </tr>
            <tr>
                ...
                <td style="width: 152px">
                    发布日期</td>
                <td style="width: 311px">
                    <asp:TextBox ID="txtFBDate" runat="server" Width="117px" BorderWidth="0px" ReadOnly="True"></asp:TextBox></td>
                <td style="width: 100px">
                </td>
            </tr>
            <tr>
