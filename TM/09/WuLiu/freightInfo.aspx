        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width: 508px; height: 192px; background-image: url(images/tanchuang.gif);">
            ...
            <tr>
                ...
                <td style="width: 311px">
                    <asp:TextBox ID="txtStart" runat="server" BorderWidth="0px" ReadOnly="True" Width="136px"></asp:TextBox></td>
            ...
            <tr>
                ...
                <td style="width: 311px; height: 18px">
                    <asp:TextBox ID="txtTerminal" runat="server" BorderWidth="0px" ReadOnly="True" Width="130px"></asp:TextBox></td>
            ...
            <tr>
                ...
                <td style="width: 111px">
                    联系电话：</td>
                <td style="width: 311px">
                    <asp:TextBox ID="txtPhone" runat="server" BorderWidth="0px" ReadOnly="True" Width="114px"></asp:TextBox></td>
                <td style="width: 100px">
                </td>
            </tr>
            <tr>
                ...
                <td style="width: 111px">
                    有效时间：</td>
                <td style="width: 311px">
                    <asp:TextBox ID="txtTerm" runat="server" BorderWidth="0px" ReadOnly="True" Width="114px"></asp:TextBox></td>
                <td style="width: 100px">
                </td>
            </tr>
            <tr>
                ...
                <td style="width: 311px; height: 24px">
                    <asp:TextBox ID="txtFBDate" runat="server" BorderWidth="0px" ReadOnly="True" Width="113px"></asp:TextBox></td>
